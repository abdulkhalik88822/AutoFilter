...
API_ID = int(environ.get('API_ID', '6324632627'))
API_HASH = environ.get('API_HASH', '4c0e5de79099f4d162759418f3c33fc0')
OWNER_ID = environ.get('OWNER_ID', '6324632627')
BOT_TOKEN = environ.get('BOT_TOKEN', "7403752023:AAE006crdi6dYI7pFcpTvDAGF_O0RRGmAM8")
...
CHAT_GROUP = int(environ.get("CHAT_GROUP", "-1002226490830"))
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002226490830') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002226490830') # request channel id ( make sure bot is admin )
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002229664892')) #Log channel id ( make sure bot is admin )
...
S_GROUP = environ.get('S_GROUP', "galexydeta")
S_CHANNEL = environ.get('S_CHANNEL', "ayush9068")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/galexydeta')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/ayush9068')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/ayush9068') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : ᴄᴏᴅᴇғʟɪx ʙᴏᴛs')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/newz2312') #Support group link ( make sure bot is admin )
